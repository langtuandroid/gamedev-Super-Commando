...
{
    public static GunTypeID currentGunTypeID;
    public static Transform currentHighestLevelObj;
    ...
    {
        PlayerPrefs.SetInt("SaveLives", 6);
    ...
    {
        get { return PlayerPrefs.GetInt("LevelHighest", 30); }
